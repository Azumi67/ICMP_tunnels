...
- در این اسکریپت 3 مدل تانل ICMP قرار دادم که بوسیله سوکت و haproxy امکان پورت فوروارد فراهم شده است.
- برای یکی از تانل های ICMP، تانل بر روی ایپی 6 هم امکان پذیر میباشد. امکان استفاده از 10 کانفیگ همزمان وجود دارد.
...
- گزینه ایپی IPV4 TCP را برای ایران انتخاب میکنیم. در این کانفیگ میخواهیم بر روی تک پورت، تانل را انجام دهیم
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- ایی سرور خارج را وارد میکنم
- پورت کانفیگ خارج هم 8080 بود
- در آخر، ایپی سرور ایرانتان با پورت مورد تظر را مشاهده میکنید. از این ادرس میتوانید در کلاینت V2ray آستفاده نمایید.
...
------------------
  ...
  - در کانفیگ های مولتی پورت یا چندین کانفیگ، پورت سمت ایران هم باید خودتان انتخاب کنید و پیش فرض نخواهد بود.
  - بهتر است از پورت یکسان استفاده کنید. به عبارتی اگر پورت خارج شما 8080 میباشد، در سمت ایران هم local port را هم 8080 وارد کنید.
...
- نخست سرور خارج را کانفیگ میکنیم
- من دو کانفیگ vmess با پورت 8080 و 8081 دارم پس تعداد کانفیگ را 2 قرار میدم و پورت کانفیگ اول را 8080 و پورت کانقیگ دوم را 8081 قرار میدم
...
- گزینه ایپی IPV4 TCP را برای ایران انتخاب میکنیم. در این کانفیگ میخواهیم بر روی دو پورت، تانل را انجام دهیم. اگر شما تعداد بیشتری پورت دارید، عدد دیگری را انتخاب نمایید
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- ایی سرور خارج را وارد میکنم
- پورت های کانفیگ خارج هم 8080 و 8081 بود
- من از پورت یکسان در سمت خارج و ایران استفاده نمودم. لوکال پورت، پورت سمت سرور ایران میباشد و این پورت، پورت نهایی شما میباشد
- در آخر، ایپی سرور ایرانتان با پورت های مورد تظر را مشاهده میکنید. از این ادرس ها میتوانید در کلاینت V2ray آستفاده نمایید.
...
- گزینه ایپی IPV6 TCP را برای ایران انتخاب میکنیم. در این کانفیگ میخواهیم بر روی دو پورت، تانل را انجام دهیم. اگر شما تعداد بیشتری پورت دارید، عدد دیگری را انتخاب نمایید
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- ایی سرور 4 خارج را وارد میکنم و سپس ایپی ورژن 6 خارج را وارد مینماییم
- پورت های کانفیگ خارج هم 8080 و 8081 بود
- من از پورت یکسان در سمت خارج و ایران استفاده نمودم. لوکال پورت، پورت سمت سرور ایران میباشد و این پورت، پورت نهایی شما میباشد
- در آخر، ایپی سرور ایرانتان با پورت های مورد تظر را مشاهده میکنید. از این ادرس ها میتوانید در کلاینت V2ray آستفاده نمایید.
...
- گزینه ایپی IPV4 UDP را برای ایران انتخاب میکنیم. در این کانفیگ میخواهیم بر روی 1 پورت، تانل را انجام دهیم. اگر شما تعداد بیشتری پورت دارید، عدد دیگری را انتخاب نمایید
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- ایی سرور خارج را وارد میکنم
- پورت کانفیگ خارج هم 50824 بود
- درکانفیگ تک پورت، به صورت پیش فرض از پورت 443 استفاده شده است.
- در آخر، ایپی سرور ایرانتان با پورت مورد تظر را مشاهده میکنید. از این ادرس میتوانید در کلاینت Wireguard آستفاده نمایید.
...
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- پس از بین SOCAT و HAPROXY ، من سوکت را انتخاب میکنم چون میخوام پورت UDP را فوروارد کنم.
- با سوکت میتوان پورت TCP هم فوروارد کرد.
- پورت کانفیگ خارج هم 50824 بود
- پورت لوکال، پورتی است که در سمت ایران وارد مینمایید. من پورت 443 را قرار میدم.
- پس پورت کلاینت وایرگارد من به جای 50824 از 443 استفاده خواهد کرد.
- در آخر، ایپی سرور ایرانتان با پورت مورد تظر را مشاهده میکنید. از این ادرس میتوانید در کلاینت Wireguard آستفاده نمایید.
...
- ایپی 4 سرور خارج را میدهیم تا ارتباط تانل برقرار شود.
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- پس از بین SOCAT و HAPROXY ، من سوکت را انتخاب میکنم و تک پورت TCP را فوروارد میکنم.
- من یک کانفیگ vmess با پورت 8080 دارم پس پورت خارج من 8080 میباشد.
- پورت لوکال، پورتی است که در سمت ایران وارد مینمایید. من پورت 443 را قرار میدم.
- پس پورت کلاینت v2rayng من به جای 8080 از 443 استفاده خواهد کرد.
- در آخر، ایپی سرور ایرانتان با پورت مورد تظر را مشاهده میکنید. از این ادرس میتوانید در کلاینت V2rayng آستفاده نمایید.
...
- ایپی 4 سرور خارج را میدهیم تا ارتباط تانل برقرار شود.
- خود اسکریپت پیش نیاز ها را دانلود میکند.
- پس از بین SOCAT و HAPROXY ، من Haproxy را انتخاب میکنم و دو عدد پورت TCP را فوروارد میکنم.
...
- در آخر، ایپی سرور ایرانتان با پورت های مورد تظر را مشاهده میکنید. از این ادرس ها میتوانید در کلاینت V2rayng آستفاده نمایید.
...
- دقت کنید در آخر از شما سوال میشود که ایا کانفیگ سرور ایران تمام شده است یا خیر. پس از انکه سرور ایران را کانفیگ کردید به این صفحه برگردید و گزینه y را بزنید تا تانل شما فعال شود در غیر اینصورت کار نخواد کرد.
...
![Exclamation-Mark-PNG-Clipart](https://github.com/Azumi67/6TO4-GRE-IPIP-SIT/assets/119934376/1b367bc9-aaed-4a8d-84a6-a2a1fc31b831)**نکات**
  ...
  - راه ساده  : ریبوت کردن سرور خارج و ایران میباشد که درست میشود.(این روش ساده تر است)
...
- من برای remote port و local port از پورت یکسان 50824 استفاده میکنم. شما میتوانید متفاوت استفاده کنید
- پورت ریورس تانل FRP به صورت پیش فرض 443 میباشد.
- دقت کنید در آخر از شما سوال میشود که ایا کانفیگ سرور ایران تمام شده است یا خیر. پس از انکه سرور ایران را کانفیگ کردید به این صفحه برگردید و گزینه y را بزنید تا تانل شما فعال شود در غیر اینصورت کار نخواد کرد.
