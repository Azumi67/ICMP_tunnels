...
------------------
  ...
  - بهتر است از پورت یکسان استفاده کنید. به عبارتی اگر پورت خارج شما 8080 میباشد، در سمت ایران هم local port را 8080 وارد کنید.
...
- پورت کلاینت وایرگارد من به جای 50824 از 443 استفاده خواهد کرد
- در آخر، ایپی سرور ایرانتان با پورت مورد نظر را مشاهده میکنید. از این ادرس میتوانید در کلاینت Wireguard استفاده نمایید.
