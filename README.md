...
- تغییرات در کامند ها داده شده که کمتر cpu را درگیر کند.. تعداد tcp window تا 4 برابر کمتر شده است اما cpu را کمتر درگیر میکند. این باعث میشه کانکشن شما کمی کندتر شود اما مشکل cpu کمتر دیده شود.
