...
- در socat امکان انتخاب پورت های توسط شما وجود دارد و پیش فرض نمیباشد.
- پورت های دیفالت بیشتر برای راحت تر کردن کانفیگ ها استفاده شده است ( چون خیلی ها میگن اسکریپت ها جالب نیست و سخته). اگر فکر میکنید مشکل ساز هستن ، باید تغییرات زیادی رو انجام بدم.
-----------
